    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> Angela Barbosa <b class="caret"></b></a>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-users fa-fw"></i> Configuracion de Usuarios</h3>
                            </div>
                        ...
                        <table id="grid-basic" class="table table-condensed table-hover table-striped" data-selection="true" data-multi-select="true" data-row-select="true">
                            <thead>
                                <tr>
                                    ...
                                    <th data-column-id="nombres" data-width="25%" data-align="left" data-header-align="center">Usuario</th>
                                    <th data-column-id="apellidouno" data-width="25%">Piel</th>
                                    <th data-column-id="apellidodos" data-width="25%">Respuestas</th>
