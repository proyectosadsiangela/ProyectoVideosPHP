                            ...
                            <a href="#">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h5 class="media-heading"><strong>Angela Barbosa</strong>
                                        </h5>
                        ...
                        <table id="grid-basic" class="table table-condensed table-hover table-striped" data-selection="true" data-multi-select="true" data-row-select="true">
                            <thead>
                                <tr>
                                    ...
                                    <th data-column-id="apellidouno" data-width="25%">Primer Apellido</th>
                                    <th data-column-id="apellidodos" data-width="25%">Segundo Apellido</th>
